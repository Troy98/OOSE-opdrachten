...
public class ConnectionHandler implements Runnable{
        ...
        static HtmlPageReader htmlPageReader = new HtmlPageReader();

        static int contentLength = htmlPageReader.calculateContentLength("index.html");
    ...
    private void writeResponse(BufferedWriter outputStreamWriter) {
        try {
            ...
            var htmlPage = htmlPageReader.readFile("index.html");
            outputStreamWriter.write(htmlPage);
            outputStreamWriter.newLine();
